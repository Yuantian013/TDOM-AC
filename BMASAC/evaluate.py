...
def run(config):
    ...
    maddpg = BMASAC.init_from_save(model_path)
    ...
    for ep_i in range(config.n_episodes):
        ...
        for t_i in range(config.episode_length):
            ...
            # if break_rewards[3] < -10 and break_rewards[0] < 9:
            #     break
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_name", default="Provided_Models",
                        help="Name of model")
    parser.add_argument("--run_num", default=9, type=int)#9 & 12
